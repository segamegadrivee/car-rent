        ...
        <header>
            <div className="header__container">
                ...
                <div className="header__circles">
                    <button className='header__favorites header__button'><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <button className='header__notification header__button'>
                    ...
                    <button className='header__settings header__button'>
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
